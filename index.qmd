...
leaflet() %>%
  ...
  addCircleMarkers(lng = mean_card_fl$longitude, lat = mean_card_fl$latitude, radius = 1)

leaflet() %>%
  addProviderTiles(provider = "Esri") %>%
  addCircleMarkers(lng = mean_ruby_throat$Longitude, lat = mean_ruby_throat$Latitude, radius = 1)
```
